            ...
            listeners: {
                ...
                //afterrender: function () {
                  afterrender: function () {
					...
					var layerGeojson = new ol.layer.Vector({
						title: 'Earthquakes',
					...
					var layer2 = new ol.layer.Heatmap({
					      title: 'Earthquakes',
						  source: new ol.source.GeoJSON({
							extractStyles: false,
							projection: 'EPSG:3857',
					...
					layer2.getSource().on('addfeature', function(event) {
						  // 2012_Earthquakes_Mag5.kml stores the magnitude of each earthquake in a
						  // standards-violating <magnitude> tag in each Placemark.  We extract it from
						  // the Placemark's name instead.
						  //var name = event.feature.get('mag');
						  //var magnitude = parseFloat(name.substr(2));
						  var magnitude = event.feature.get('mag');
						  event.feature.set('weight', magnitude - 6);
						});
